...
public interface MessageGateway {
     ...
     *
     *  With SpringBoot 2.6.6 timeout is never thrown when replyTimeout is missing here.
     ...
     *  Sometimes instead of having onFailure called onSuccess is being called with null payload
